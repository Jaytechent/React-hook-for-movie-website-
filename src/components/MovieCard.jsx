...
const MovieCard = ({ title, description, posterUrl, rating, youtubeLink }) => {
  return (
    <Card
      className="grid gap-3 bg-blue-300 border-8 border-blue-800 "
      hoverable
    ...
    >
      ...
      />
      <Rate disabled defaultValue={rating} className="bg-blue-800 rounded-xl" />
      <a href={youtubeLink} target="_self">
        <button className="bg-blue-700 rounded-2xl font-sans font-medium">
          {" "}
          Click to Watch
        </button>
      </a>
